<style>
                            .sl_kenny_m {position:relative;width:610px;height:320px;background:#000;}
                            ...
                            .sl_kenny_m .prev_button{position:absolute;top:50%;left:10px;z-index:10;width:32px;height:34px;overflow:hidden;text-indent:-9999em;margin-top:-25px;background:url(https://lh3.googleusercontent.com/-uYigeGxXC4Y/UcFlHWyz4jI/AAAAAAAAA8g/pMAgK-IBEBE/w32-h34-no/prev.png) no-repeat left top;}
                            .sl_kenny_m .next_button{position:absolute;top:50%;right:10px;z-index:10;width:32px;height:34px;overflow:hidden;text-indent:-9999em;margin-top:-25px;background:url(https://lh4.googleusercontent.com/-6Efwz5UTYkE/UcFlHWyEa3I/AAAAAAAAA8c/IHIiCLjc9RE/w32-h34-no/next.png) no-repeat left top;}
                            ...
                            .sl_kenny_m .ll_sl_kenny{z-index:15;position:absolute;bottom:0;left:0;display:none;}.loading{position:absolute;top:50%;right:50%;z-index:10000;margin:-16px -16px;color:#fff;text-indent:-9999em;overflow:hidden;background:url(https://lh4.googleusercontent.com/-dhmJXPjgiyE/UcFk83YqJsI/AAAAAAAAA74/D2oEhV1DE_0/s32-no/ajax-loader.gif) no-repeat left top;width:32px;height:32px;}
                            ...
                            .sl_kenny_m .focus_button{position:absolute;top:50%;z-index:10;width:42px;height:42px;overflow:hidden;text-indent:-9999em;margin-top:-25px;background:url(https://lh4.googleusercontent.com/-pLISFIqC5xY/UcFlGkfoBwI/AAAAAAAAA8E/KvsP73dKvXM/s42-no/focus-button.png) no-repeat left top;opacity:0;}
                            .sl_kenny_m .play_pause_button{position:absolute;top:50%;z-index:16;width:42px;height:42px;overflow:hidden;text-indent:-9999em;margin-top:-25px;background:url(https://lh5.googleusercontent.com/-ndca1xYfww0/UcFlGpgxfKI/AAAAAAAAA8I/9-kPKCrmiwk/s42-no/pause-button.png) no-repeat left top;opacity:0;}
                            .sl_kenny_m .play_pause_button.play_button{background:url(https://lh6.googleusercontent.com/-fa4-Q1IkdY4/UcFlHfxvwwI/AAAAAAAAA8U/YtGCGkZ3SYg/s42-no/play-button.png) no-repeat left top;}.sl_kenny_m_small {width:200px;height:100px;}
                          </style>